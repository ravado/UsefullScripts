...
$SUDO curl -fsSL https://raw.githubusercontent.com/ravado/usefull-scripts/refs/heads/main/photo-frame/logs-and-monitoring/default_config.alloy -o /etc/alloy/config.alloy
